...
class AIService(BaseService):
    ...
    def execute_completion(
        ...
        if os.environ.get("AUREON_TEST_MOCK_AI") == "true":
            ...
            from app.modules.ai.providers.ai.gemini.provider import MODELS as GEMINI_MODELS
            from app.modules.ai.providers.ai.groq.provider import MODELS as GROQ_MODELS
