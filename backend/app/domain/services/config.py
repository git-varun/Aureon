    ...
    def dispatch_job(self, job_name: str, log_id: Optional[int] = None, user_id: Optional[uuid.UUID] = None) -> Optional[str]:
        ...
        try:
            ...
            task_mapping = {
                ...
                "run_signals": "app.workers.ingestion.tasks.run_signals_task",
                "seed_price_history": "app.workers.ingestion.tasks.seed_price_history_task",
                "aggregate_sentiment": "app.workers.ingestion.tasks.aggregate_sentiment_task",
                "seed_fundamentals": "app.workers.ingestion.tasks.seed_fundamentals_task",
                "fetch_fx_rate": "app.workers.ingestion.tasks.fetch_fx_rate_task",
                "compute_state": "app.workers.ingestion.tasks.compute_state_task",
                "accrue_epf": "app.workers.ingestion.tasks.accrue_epf_task",
                "accrue_eps": "app.workers.ingestion.tasks.accrue_eps_task",
                "bond_mtm": "app.workers.ingestion.tasks.bond_mtm_task",
                "insurance_premium": "app.workers.ingestion.tasks.insurance_premium_task",
                "compute_technicals": "app.workers.ingestion.tasks.compute_technicals_task",
                "notify_daily_summary": "app.workers.ingestion.tasks.notify_daily_summary_task",
                "clean_stale_signals": "app.workers.ingestion.tasks.clean_stale_signals_task",
                "seed_market_universe": "app.workers.ingestion.tasks.seed_market_universe_task",
                "refresh_watchlist_prices": "app.workers.ingestion.tasks.refresh_watchlist_prices_task",
