...
def test_polygon_quote_normalization() -> None:
    ...
    with patch("app.infrastructure.providers.polygon.settings.POLYGON_API_KEY", "test-key"), \
         patch("app.infrastructure.providers.polygon.requests.get", return_value=fake_response):
