...
def test_finnhub_quote_normalization() -> None:
    ...
    with patch("app.infrastructure.providers.finnhub.settings.FINNHUB_API_KEY", "test-key"), \
         patch("app.infrastructure.providers.finnhub.requests.get", return_value=fake_response):
